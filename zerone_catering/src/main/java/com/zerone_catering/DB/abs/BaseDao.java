package com.zerone_catering.DB.abs;
...
public class BaseDao extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "zerone_catering_.db";
...
//        createSessionTable(db);
    ...
    public void createUserInfo(SQLiteDatabase db) {
        ...
        sb.append("      'organization_name' varchar(10) not null,");
        sb.append("      'fansnamage_id' varchar(10) not null,");
