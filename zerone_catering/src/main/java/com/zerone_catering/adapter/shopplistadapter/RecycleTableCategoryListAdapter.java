...
public class RecycleTableCategoryListAdapter extends RecyclerView.Adapter<RecycleTableCategoryListAdapter.ViewHolder> {

    public Context mContext;
    OnItemClickListener mOnItemClickListener;
    //当前选中的位置
    private int selectPosition;
    private List<TableCatCashierFinal> clist;

    public RecycleTableCategoryListAdapter(List<TableCatCashierFinal> clist, Context context) {
        this.clist = clist;
     ...
     */
    public void changeData(List<TableCatCashierFinal> clist) {
        this.clist = clist;
