...
public class CatingListAdapter extends RecyclerView.Adapter<CatingListAdapter.ViewHolder> {
    ...
    public CatingListAdapter(List<GoodsCategroyListBean.DataBean.CategorylistBean> dataList, Context context) {
