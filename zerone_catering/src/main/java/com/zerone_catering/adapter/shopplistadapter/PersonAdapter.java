...
//        Log.i("URL", "picture::=" + s);IpConfig.URL_GETPICTURE + dataList.get(position).getThumb().get(0).getThumb()
        Glide.with(mContext).load("").centerCrop().placeholder(R.mipmap.app_logo).crossFade().into(holder.shop_picture);
