...
public class MakeOrderDetialsCashierListItemAdapter extends BaseAdapter {
    private Context context;
    private List<OrderCashierListBean> list;
    private LayoutInflater inflate;

    public MakeOrderDetialsCashierListItemAdapter(Context context, List<OrderCashierListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.goodsName.setText(list.get(position).getOrdersn());
        holder.goodsMoney.setText("￥" + list.get(position).getOrder_price());
