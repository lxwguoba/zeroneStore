...
import com.zerone_catering.Layoutmanage.MyLayoutManage;
import com.zerone_catering.R;
import com.zerone_catering.adapter.cart_list.ListGoodsDetails_Adapter;
import com.zerone_catering.adapter.shopplistadapter.PersonAdapter;
import com.zerone_catering.adapter.shopplistadapter.ProductListAdapter;
import com.zerone_catering.adapter.shopplistadapter.RecycleGoodsCategoryListAdapter;
import com.zerone_catering.adapter.shopplistadapter.RecycleProductCategoryListAdapter;
import com.zerone_catering.avtivity.BaseSet.BaseActvity;
import com.zerone_catering.avtivity.openorderpage.serarch.SearchActivity;
import com.zerone_catering.domain.SearchBean;
...
import com.zerone_catering.domain.refresh.SetDataGoodsOrder;
import com.zerone_catering.domain.shoplistbean.GoodsCategroyListBean;
 ...
 */
public class OrderListActvity extends BaseActvity {
            ...
            switch (msg.what) {
                ...
                case 110:
                    ...
                    if (buycartshoplist.size() > 0 && buyShoppingList.size() > 0) {
                        ...
                        intent01.putExtra("tableid", tableId);
    ...
    private void initGetData() {
        ...
        NetUtils.netWorkByMethodPost(mContent, loginMap, IpConfig.URL_GLIST, handler, 0);
    }
    ...
    public void getCategoryInfo() {
        ...
        NetUtils.netWorkByMethodPost(OrderListActvity.this, loginMap, IpConfig.URL_GCATERING, handler, 10);
    }
