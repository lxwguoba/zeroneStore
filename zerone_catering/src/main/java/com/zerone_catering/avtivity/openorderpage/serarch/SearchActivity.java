package com.zerone_catering.avtivity.openorderpage.serarch;
...
import com.zerone_catering.adapter.MyAdapter;
...
import com.zerone_catering.avtivity.openorderpage.MakeSureTheOrderActivity;
...
import com.zerone_catering.utils.MapUtilsSetParam;
...
public class SearchActivity extends BaseActvity {
    ...
    @Bind(R.id.search_money)
    TextView searchMoney;
    @Bind(R.id.sure_btn)
    TextView sureBtn;
