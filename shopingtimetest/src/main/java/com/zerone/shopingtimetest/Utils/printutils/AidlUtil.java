package com.zerone.shopingtimetest.Utils.printutils;
...
import com.zerone.shopingtimetest.Bean.print.TableItem;
...
public class AidlUtil {
     ...
     * 打印文字
     */
    public void printCenterText(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
            Toast.makeText(context, R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
