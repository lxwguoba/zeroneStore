package com.zerone.shopingtimetest.Adapter.shopplistadapter;
...
public class RecycleProductCategoryListAdapter extends RecyclerView.Adapter<RecycleProductCategoryListAdapter.ViewHolder> {
    ...
    public RecycleProductCategoryListAdapter(List<CatingBean> clist, Context context) {
        this.clist = clist;
     ...
     */
    public void changeData(List<CatingBean> clist) {
        this.clist = clist;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.goodsCategoryName.setText(clist.get(position).getName());
        if (selectPosition != -1) {
